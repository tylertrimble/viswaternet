...
def plot_continuous_nodes(model,ax,parameter=None, value=None, tanks=True, reservoirs=True, pumps=True, valves=True,cmap= default_cmap, color_bar_title=None,node_size=100, node_shape='.',edge_colors=None,line_widths=None,savefig=True, save_name=None):
...
def plot_continuous_links(model,ax,parameter=None,value=None,min_width=1,max_width=5,tanks=True, reservoirs=True, pumps=True, valves=True,cmap=default_cmap,color_bar_title=None,savefig=True, save_name=None):
