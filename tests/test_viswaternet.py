...
class TestPlottingFunctions(unittest.TestCase):
    ...
    def test_animate_plot(self):
        ...
        model.animate_plot(ax=ax,function=model.plot_discrete_nodes,parameter='pressure',last_timestep=5,gif_save_name='discrete')
        self.assertTrue(os.path.isfile('discrete.gif'),"animate_plot() is not generating discrete plot gif file.")
        
        fig,ax=plt.subplots(figsize=(15,15))
        
        model.animate_plot(ax=ax,function=model.plot_continuous_nodes,parameter='pressure',last_timestep=5,gif_save_name='continuous')
