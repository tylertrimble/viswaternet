...
mean, elmnt_list = visinit.get_parameter(model,"node",parameter="pressure",value="mean")
#Get standard deviation at  each node
stddev, elmnt_list = visinit.get_parameter(model,"node",parameter="pressure",value="stddev")
#Bin standard deviation values
binnedParameter, interval_names = visinit.bin_parameter(model, stddev, elmnt_list, 5)
