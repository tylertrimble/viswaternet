...
def plot_discrete_nodes(
    ...
    if parameter is not None:
        ...
        base.draw_base_elements(
            self, ax, draw_nodes=draw_nodes, draw_reservoirs=draw_reservoirs, draw_tanks=draw_tanks,
            draw_valves=draw_valves, draw_pumps=draw_pumps, 
            element_list=node_list, reservoir_size=reservoir_size,
        ...
        base.draw_legend(
            ...
            draw_links=draw_links, draw_valves=draw_valves,
...
def plot_discrete_links(
    ...
    if parameter is not None:
        ...
        draw_discrete_links(
            ...
            label_list=label_list, cmap=cmap,
            color_list=color_list, link_style=link_style,
            link_arrows=link_arrows)
        base.draw_base_elements(
            self, ax, draw_nodes=draw_nodes, draw_links=draw_links, draw_reservoirs=draw_reservoirs,
            draw_tanks=draw_tanks, draw_valves=draw_valves, draw_pumps=draw_pumps, 
            element_list=link_list, reservoir_size=reservoir_size,
            reservoir_color=reservoir_color, reservoir_shape=reservoir_shape,
            reservoir_border_color=reservoir_border_color,
            reservoir_border_width=reservoir_border_width,
            tank_size=tank_size, tank_color=tank_color, tank_shape=tank_shape,
        ...
        link_list = [name for name in link_list
                  if ((name not in model["G_list_pumps_only"] or pump_element == 'node' or draw_pumps == False) \
                  and (name not in model["G_list_valves_only"] or valve_element == 'node' or draw_valves == False) \
