...
mean, elmnt_list = model.get_parameter(
    "node", parameter="pressure", value="mean")
# Get standard deviation at  each node
stddev, elmnt_list = model.get_parameter(
    "node", parameter="pressure", value="stddev")
...
style = vis.NetworkStyle(cmap="winter_r",
