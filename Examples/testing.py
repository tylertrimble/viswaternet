...
visplot.plot_discrete_nodes(model, ax, parameter='elevation',legend_sig_figs=2,font_size=11,legend_title='Elevation (ft)',legend_title_font_size=17,reservoir_border_color='b',reservoir_border_width=2)
#%%
